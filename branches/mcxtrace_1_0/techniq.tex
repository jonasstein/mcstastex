...
\end{center}
\caption{Illustration of the effect of direction focusing in \MCX\
...
velocity, spin, time). We show in Table \ref{t:mc_accuracy} a rough estimate of
the accurarcy on integrals as a function of the number of records reaching the
