...
Other implementation of the same concept are \emph{Ray}\cite{Ray-website} from BESSY and Xtrace(\cite{Xtrcae-website}).
...
\MCX\ uses a space with $d=11$ parameters to describe x-rays (position,
wavevector, polarisation, phase, time). We show in Table \ref{t:mc_accuracy} a rough estimate of
