...
\component{Source\_Optimizer}{E. Farhi}{options}{bins, step, keep}{not fully validated}

This component is not exactly a source, but rather a neutron beam modifier. It should be positioned after the source, anywhere in the instrument description.
...
distribution tables. The neutron energy ($\surd v_x^2 + v_y^2 +
