...
An \ce{\end{lstlisting}Al2O3} powder sample and a vanadium sample. The instrument
...
using the direct beam and scattering from V and \ce{\end{lstlisting}Al2O3}
...
The result of a $2\theta_s$ scan on an \ce{\end{lstlisting}Al2O3}
...
\begin{figure}
  ...
  \end{center}
\caption{TAS1: $2\theta_s$ scans on \ce{\end{lstlisting}Al2O3} in two-axis, focusing mode.
Collimations: open-30'-28'-67'.
"$\times$": measurements, "o": simulations.
