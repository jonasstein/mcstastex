...
It is our intention to extend the list of instrument examples extensively
...
triple-axis spectrometer TAS1 at the now closed source of Ris\o\ National Laboratory.
...
standard experiment from TAS1, Ris\o . The measurement series
...
mode on a V-sample showed a surprising offset from 0 degrees, see
