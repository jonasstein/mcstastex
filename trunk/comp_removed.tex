...
in a separate manual describing the McStas components. The McStas component manualis edited by the McStas authors and it will include contributions from users writing components. As a complement to the \MCS\ component manual, you may use the \verb+mcdoc -s+ command to obtain the on-line component documentation and refer to the McStas web-page~\cite{mcstas_webpage} where all components are documented using the McDoc system.
