...
For details about performing simulations, we refer to
...
In case of errors, questions, suggestions,
...
then included in the system manual) include

\begin{itemize}
\item{Validation of most components against analytical formula, 
and benchmarking with simple cases}
...
\item{A suite of sample components}
  ...
  \item \verb+Isotropic_Sqw+ isotropic sample (powder, liquid, glass) 
