...
\item The \verb+PREVIOUS+ and \verb+MYSELF+ keywords can be used in component instance parameters and positioning (AT/ROTATED) so that one can make use of 'MC_GETPAR(PREVIOUS, parameter)' directly in the TRACE section.
\end{itemize}
...
\item Adde ISIS_CRISP which uses new multilayer sample (R. Dalgliesh, ISIS)
