...
\component{Powder\_N}{System}{$radius$, $radius_i$, $h$, $xwidth$, $yheight$, $zthick$,  $xwidth_i$, $yheight_i$, $zthick_i$ $\sigma_{\rm abs}$,
  $\sigma_{\rm inc}$, $V_0$, $f_{\rm pack}$, reflections, format, DW, concentic, and more}{}{}
...
A usage example of this component can be found in the \verb+Neutron site/Tutorial/templateDIFF+ instrument from the \verb+mcgui+.
...
sample of size $xwidth$x$yheight$x$zthick$. At the users choice, an inner 'hollow' can be
specified.
