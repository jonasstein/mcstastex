...
even thousands of lines of formulae, and ``errare humanun est''. Thus the
...
\item The \MCS\ meta-language is described in chapter~\ref{s:kernel}. This
  ...
  that aid in the writing of simulations. See appendix~\ref{c:kernelcalls} for more details.
