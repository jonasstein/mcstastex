...
Ge.laz             & 8.42      & 0.18     &2.2       &1211.4    &5400  & Ge\_liq\_coh.sqw and Ge\_liq\_inc.sqw\\
H2O\_ice\_1h.laz     & 7.75      & 160.52   &0.6652    &273       &     &\\
He4\_liq\_coh.sqw    & 1.34      & 0        &0.00747   &0         &   & $S(q,\omega)$ data\\
...
Rb.laz             & 6.32      & 0.5      &0.38      &312.46    &{\bf 1300}  & Rb\_liq\_coh.sqw and Rb\_liq\_inc.sqw\\
...
Zr.laz             & 6.44      & 0.02     &0.185     &2128      &3800&\\
    ...
    \caption{Powders of the \MCS\ library \cite{icsd_ill,ILLblue}. Low $c$ and high $\sigma_{abs}$ materials are highlighted.}
    \label{t:material-data}
    \index{Library!Components!data}
    }
  \end{center}
\end{table}
