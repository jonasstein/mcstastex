...
To load an instrument, select ``Other'' from the ``Neutron site''
...
Variables' by cfreating \verb+MCSTAS+ with the value \verb+C:\mcstas\lib+
...
\begin{quote}
  \texttt{mcstas2vitess {\it file.{m|sci}\/}}
\end{quote}
