...
\titel{User and Programmers Guide to the Neutron Ray-Tracing Package
 \MCS , Version \version}
\forfatter{Peter Willendrup, Emmanuel Farhi, Klaus Lieutenant, Kim
  Lefmann, and Peter Christiansen}
\isbn{ISBN 87--550--3561--2 (Internet)}\issn{0106--2840}
\afdeling{Materials Research Department}
\dato{\reldate}
\regnummer{---}
\projektnummer{---}
\sider{\thepage}\tabeller{12}\figurer{21}\referencer{47}
