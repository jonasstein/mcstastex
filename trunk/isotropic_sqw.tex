...
\begin{verbatim}
  powder_format=qSq
\end{verbatim}
The 'Sqw\_coh' file should contains a single numerical block, which column assignment is defaulted as $q$ and $S(q)$ being the first and second columns respectively. This may be overridden from the file header with '\#column' keywords, as in the example:
\begin{verbatim}
  #column_q  2
  #column_Sq 1
\end{verbatim}
...
Central component may be of any type, not specifically an Isotropic\_sqw instance.