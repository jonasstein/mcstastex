...
instruments as well as polarised neutrons, and includes a library 
of standard components with in total around 60 components.
...
component definitions appears in appendix~\ref{kernelcalls}.
